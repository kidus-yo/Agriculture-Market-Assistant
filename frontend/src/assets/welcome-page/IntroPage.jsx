...
export default function IntroPage(){
  ...
  const handleFormSubmit = (e) => {
    ...
    triggerToast('Access Granted!', `Welcome as ${selectedRole}.`);
    setEmail('');
  };
  ...
  return(
          <div className="agrivox-page-wrapper">
            ...
            <div className={`agrivox-toast ${toast.visible ? 'agrivox-toast-active' : ''}`}>
              <div className="agrivox-toast-icon">
                <CheckIcon />
              </div>
              <div>
                <p className="agrivox-toast-title">{toast.title}</p>
                <p className="agrivox-toast-message">{toast.message}</p>
              </div>
            </div>

            {isModalOpen && (
              <div className="agrivox-modal-overlay" onClick={() => setIsModalOpen(false)}>
                <div className="agrivox-modal-card" onClick={(e) => e.stopPropagation()}>
                  <button className="agrivox-modal-close" onClick={() => setIsModalOpen(false)}>
                    <CloseIcon />
                  </button>
                  <h2>Join AgriVox Ecosystem</h2>
                  <p>Select your role and enter your email to request access.</p>
            
                  <div className="agrivox-role-selector">
                    <button
                      type="button"
                      className={`agrivox-role-card ${selectedRole === 'farmer' ? 'active' : ''}`}
                    ...
                    <button
                      type="button"
                      className={`agrivox-role-card ${selectedRole === 'trader' ? 'active' : ''}`}
                  ...
                  <form onSubmit={handleFormSubmit}>
                    ...
                    />
                    <button type="submit" className="agrivox-btn-primary">
                      Submit Request
                    </button>
                  </form>
                </div>
